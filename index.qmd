...
::: {.notes}
14 years later we still struggle to have a decent roadmap and we may feel alone... but you're not.
:::
...
- **_Big Data_ (~2010 onwards):** `Hadoop`, `MapReduce`, `Hive`, `Spark` (in 2014)
- **_Kaggle_ era:** `xgboost`
- **_Data Product_ era:**
- **_Deep Learning_ era (~2014 onwards):** NNets, CNNs,  
...
![](img/model-complete-arrow.png){fig-align="center" height="750"}
...
![](img/crop-genai.png){.absolute top=0 right=0 height=125}
...
Computational thinking is commonly defined as a set of cognitive and social skills that are applied in problem-solving processes.
...
The term statistical thinking was coined by Deming7 and developed by Moore.11 It has since received a great deal of attention and discussion with- in the statistics education community, and voices have emerged, calling for statistical thinking for all. Statistical thinking is associated with understanding the essence, characteristics, and variability of real-life data and its importance for solving real-life problems is.6 
